    ...
    <div style={divStyle} >  
      <div className='md:flex'>
        <div className='flex ml-10  md:text-4xl space-y-4 md:w-1/2'>
          <div className=' md:ml-10 mt-40 md:text-4xl space-y-4 text-xl md:font-normal font-bold font-Aclonica'>
        ...
        <div className='md:mt-32 md:ml-40 font-Aclonica'>
            <div className='bg-black rounded-full w-40 text-white h-40 text-center ml-20 mt-4'>
